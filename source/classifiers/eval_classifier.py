...
CKPT_PATH = "/home/alexandre/logs/classif21juin/9fold_cross-validation/version_3/checkpoints/epoch=199-step=34600.ckpt"
DATA_PATH = "/home/alexandre/dataset/IDMT_FULL_CUT_22050/out.csv"
...
trained_clf = MLPClassifier.load_from_checkpoint(CKPT_PATH, input_size=143, output_size=11,
...
fig = util.make_confusion_matrix(cm, group_names=CLASSES, categories=CLASSES, cbar=False)
fig.show()
plt.show(block=True)
